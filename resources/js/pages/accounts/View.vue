                        ...
                        <template v-else>
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div>
                                    ...
                                    <p class="text-lg font-medium">{{ props.account.account }}</p>
                                </div>

                                <div>
                                    <p class="text-sm text-muted-foreground">Currency</p>
                                    <p class="text-lg font-medium">{{ props.account.currency }}</p>
                                </div>

                                <div>
                                    <p class="text-sm text-muted-foreground">Beneficiary</p>
                                    <p class="text-lg font-medium">{{ props.account.beneficiary }}</p>
                                </div>

                                <div>
                                    <p class="text-sm text-muted-foreground">Intermediary</p>
                                    <p class="text-lg font-medium">{{ props.account.intermediary }}</p>
                                </div>

                                <div>
                                    <p class="text-sm text-muted-foreground">Institution</p>
                                    <p class="text-lg font-medium">{{ props.account.institution }}</p>
                                </div>
                            </div>
                        </template>
                    </div>
